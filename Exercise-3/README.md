...
## My Solution
1. Generate features with 10, 20, 50 and 1000 random orientations of 7 objects. The datasets are save in `./sensor_stick/scripts` with the name of **training_set_N_epochs.sav**.

2. Choose the biggest dataset to train SVM with **linear** kernel. The accuracy on testing data is 0.9862, very good.
![Confusion Matrix without Normalization](my_classification_result.png "Confusion Matrix without Normalization")
![Confusion Matrix with Normalization](my_classification_result2.png "Confusion Matrix without Normalization")

3.  Aplly our classifier to the point cloud input. An exciting result.
![Object Recognition Result](object_recognition_result.png "Confusion Matrix without Normalization")
